/**
 * @requires mongoose to connect app to mongoDB database and implements data schema using models.
 * @requires './models.js' in this file data schema have been defined
